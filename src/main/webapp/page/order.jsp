 ...
 <body class="sticky-header left-side-collapsed" >
    ...
    <!-- left side start-->
		...
		<div class="main-content" style="position: absolute; z-index: 1; width: 95%;" >
			...
			<label class="control-label col-sm-1" for="txt_search_orderNum">订单号</label>
			<div class="col-sm-3">
			<input type="text" class="form-control" id="txt_search_orderNum" name="orderNum">
			</div>
			...
			<div class="panel-heading">关于我的订单</div>
