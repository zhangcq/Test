 ...
 <body class="sticky-header left-side-collapsed">
    ...
    <!-- left side start-->
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						<li class="active"><a href="page/user.jsp"><i class="fa fa-user"></i><span>用户管理</span></a></li>
		...
		<div class="main-content" style="position: absolute; z-index: 1; width: 95%">
			...
			<label class="control-label col-sm-1" for="txt_search_uname">用户名称</label>
			<div class="col-sm-3">
			<input type="text" class="form-control" id="txt_search_uname" name="uname">
			</div>
			<label class="control-label col-sm-1" for="txt_search_utel">联系方式</label>
			<div class="col-sm-3">
			<input type="text" class="form-control" id="txt_search_utel" name="utel">
			</div>
        ...
        <div id="add" style="display: none; margin: 0 auto;width:300px; height:250px; position: absolute;z-index: 10; left: 40%;top:40%; border: 1px solid gray;background-color: white;">
				...
				<label style="margin-left: 20px;">用户名称:</label>
				<input type="text" id="add-uname" name="uname">
				</div>
				
				<div style="margin-top: 20px;">
				<label style="margin-left: 20px;">联系方式:</label>
				<input type="text" id="add-utel" name="utel">
				</div>
				...
				<div style="margin-top: 20px;" >
				<label style="margin-left:20px;">用户级别:</label>
				<select id="add-level">
					<option>一卡通管理员</option>
					<option>车辆调度管理员</option>
					<option>车辆管理员</option>
					<option>仓储管理员</option>
				</select>
				</div>
		...
		<div id="edit" style="display: none; margin: 0 auto;width:300px; height:250px; position: absolute;z-index: 10; left: 40%;top:40%; border: 1px solid gray;background-color: white;">
				...
				<div style="margin-top: 20px;">
				<label style="margin-left: 20px;">联系方式:</label>
				<input type="text" id="edit-utel" name="utel">
				</div>
