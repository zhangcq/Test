 ...
 <body class="sticky-header left-side-collapsed">
    ...
    <!-- left side start-->
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="active"><a href="page/card.jsp"><i class="fa fa-credit-card"></i><span>一卡通管理</span></a></li>
		...
		<div class="main-content" style="position: absolute; z-index: 1; width: 95%">
			...
			<label class="control-label col-sm-1" for="txt_search_cardNum">卡号</label>
			<div class="col-sm-3">
			<input type="text" class="form-control" id="txt_search_cardNum" name="cardNum">
			</div>
			<label class="control-label col-sm-1" for="txt_search_uname">持卡人姓名</label>
			<div class="col-sm-3">
			<input type="text" class="form-control" id="txt_search_uname" name="uname">
			</div>
			<label class="control-label col-sm-1" for="txt_search_cardType">卡类型(临时、长期)</label>
			<div class="col-sm-3">
			<input type="text" class="form-control" id="txt_search_cardType" name="cardType">
			</div>
        ...
        <div id="add" style="display: none; margin: 0 auto;width:300px; height:250px; position: absolute;z-index: 10; left: 40%;top:40%; border: 1px solid gray;background-color: white;">
				...
				<label style="margin-left: 20px;">持卡人姓名:</label>
				<input type="text" id="add-uname" name="uname">
				</div>
				
				<div style="margin-top: 20px;">
				<label style="margin-left: 20px;">持卡人所在公司:</label>
				<input style="margin-left: 20px;" type="text" id="add-companyName" name="companyName">
				</div>
				
				<div style="margin-top: 20px;" >
				<label style="margin-left: 20px;">卡类型:</label>
				<select id="add-cardType">
					<option>临时卡</option>
					<option>长期卡</option>
				</select>
				</div>
		...
		<div id="recharge" style="display: none; margin: 0 auto;width:300px; height:100px; position: absolute;z-index: 10; left: 40%;top:40%; border: 1px solid gray;background-color: white;">
				<div style="margin-top: 20px;">
				<label style="margin-left: 20px;">充值金额:</label>
				<input style="margin-left: 20px;" type="text" id="recharge-money" name="rechargeMoney">
				</div>
				<div style="margin-top: 10px;">
					<button type="button" class="btn btn-default" style="margin-left: 90px;" onclick="rechargeOk()">确认</button>
					<button type="button" class="btn btn-default" style="margin-left: 20px;" onclick="cancel()">取消</button>
				</div>
		</div>
