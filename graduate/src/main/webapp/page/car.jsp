...
<link href="css/bootstrap-table.css" rel="stylesheet" />
 ...
 <body class="sticky-header left-side-collapsed" >
    ...
    <!-- left side start-->
        ...
        <div id="thing" style="display: none; margin: 0 auto;width:900px; height:600px; position: absolute;z-index: 10; left: 20%;top:10%; background-color: white; ">
			<div style="float: right;width:900px; height: 30px;"><button class="btn" style="float: right; " onclick="cancel()">取消</button></div>
			<table id="tb_mything" style="width:900px; margin-top: 10px;"></table>
		</div>
