 ...
 <body class="sticky-header left-side-collapsed" >
    ...
    <!-- left side start-->
		...
		<div class="main-content" style="position: absolute; z-index: 1; width: 95%">
			...
			<label class="control-label col-sm-1" for="txt_search_departure">发货地</label>
			<div class="col-sm-3">
			<input type="text" class="form-control" id="txt_search_departure" name="departure">
			</div>
			<label class="control-label col-sm-1" for="txt_search_destination">收货地</label>
			<div class="col-sm-3">
			<input type="text" class="form-control" id="txt_search_destination" name="destination">
			</div>
			<label class="control-label col-sm-1" for="txt_search_destination"></label>
			<div class="col-sm-3">
			<div style="width: 100%;height: 34px;padding: 6px 12px;" id="txt_search_destination"></div>
			</div>
			<label class="control-label col-sm-1" for="txt_search_releaseTime" style="margin-top: 10px;">发货时间</label>
			<div class="col-sm-3" style="margin-top: 10px;">
			<input type="text" class="form-control je_Date" id="txt_search_releaseTimeBegin" readonly name="releaseTimeBegin">
			</div>
			<div class="col-sm-3" style="margin-top: 10px;">
			<input type="text" class="form-control je_Date" id="txt_search_releaseTimeEnd" readonly name="releaseTimeEnd">			
			</div>
        ...
        <div id="add" style="display: none; margin: 0 auto;width:300px; height:350px; position: absolute;z-index: 10; left: 40%;top:40%; border: 1px solid gray;background-color: white;">
				
				<div  style="margin-top: 20px;" >
				<label style="margin-left: 20px;">发货地:</label>
				<input type="text" id="add-departure" name="uname">
				</div>
				
				<div style="margin-top: 20px;">
				<label style="margin-left: 20px;">收货地:</label>
				<input type="text" id="add-destination" name="destination">
				</div>
				
				<div style="margin-top: 20px;">
				<label style="margin-left: 20px;">货物名称:</label>
				<input type="text" id="add-thingName" name="thingName">
				</div>
				
				<div style="margin-top: 20px;" >
				<label style="margin-left:20px;">货物类型:</label>
				<select id="add-thingtype">
					<option>食品</option>
					<option>生活用品</option>
					<option>杂物</option>
					<option>其他</option>
				...
				<div style="margin-top: 20px;" >
				<label style="margin-left: 20px;">货物重量:</label>
				<input type="text" id="add-weight"  name="companyName">
				</div>
				
				<div style="margin-top: 20px;" >
				<label style="margin-left: 20px;">发货时间:</label>
				<input type="text" class="je_Date" id="add-releaseTime" readonly name="releaseTime">
				</div>
		...
		<div id="edit" style="display: none; margin: 0 auto;width:300px; height:350px; position: absolute;z-index: 10; left: 40%;top:40%; border: 1px solid gray;background-color: white;">
				...
				<div style="margin-top: 20px;">
				<label style="margin-left: 20px;">货物名称:</label>
				<input type="text" id="edit-thingName" name="utel">
				</div>
				
				<div style="margin-top: 20px;" >
				<label style="margin-left:20px;">货物类型:</label>
				<select id="edit-thingtype">
					<option>食品</option>
					<option>生活用品</option>
					<option>杂物</option>
					<option>其他</option>
				...
				<div style="margin-top: 20px;" >
				<label style="margin-left: 20px;">发货时间:</label>
				<input type="text" class="je_Date" id="edit-releaseTime" readonly name="releaseTime">
				</div>
				<div style="margin-top: 10px;">
...
<script src="js/mything.js"></script>
